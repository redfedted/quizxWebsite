function TandC() {
  return (
    <div className="flex flex-col w-10/12 gap-3 mx-auto my-10 font-bold">
      ...
      <h2 className="text-2xl">Last updated 26 October 2023</h2>{" "}
      <h3>
        At QuizX, accessible from https://www.thequizx.com/, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by QuizX
      ...
      <h3>
        ...
        shared and/or collect in QuizX. This policy is not applicable to any
      ...
      <h3>
        QuizX follows a standard procedure of using log files. These files log
      ...
      <h3>
        ...
        advertising partners of QuizX.
      </h3>
      <h3>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on QuizX, which are sent directly
      ...
      <h3>
        Note that QuizX has no access to or control over these cookies that are
        used by third-party advertisers.
      </h3>
      <h2 className="text-2xl">Third Party Privacy Policies</h2>
      <h3>
        QuizX's Privacy Policy does not apply to other advertisers or websites.
      ...
      <h3>
        QuizX does not knowingly collect any Personal Identifiable Information
