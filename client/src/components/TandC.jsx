    ...
    <div>
      ...
      <div className="mx-auto my-10 flex w-10/12 flex-col gap-3 font-bold">
        ...
        <h3>
          ...
          by QuizX and how we use it. If you have additional questions or
        ...
        <h3>
          Note that QuizX has no access to or control over these cookies that
          are used by third-party advertisers.
        </h3>
        <h2 className="text-2xl">Third Party Privacy Policies</h2>
        <h3>
          QuizX's Privacy Policy does not apply to other advertisers or
