...
function StartPage({ setStartPage }) {
  return (
    <div className="mx-[0.826rem]">
      ...
      <div className="mx-[0.666rem] mb-[0.5rem] text-[2.25rem] font-bold">
        {" "}
        <h2>Introducing</h2>
        <h2 className="text-[#D2322F]">Campus Ecosystem</h2>
      </div>

      <h3 className="mx-[0.666rem] mb-[1.5rem] w-9/12 text-[1.5rem] leading-[28.77pxrem] opacity-75">
        Reimagine the Educational Experience for your Institution
      </h3>
      <button
        className="border-1 mx-[0.666rem] mb-[2.563rem]  rounded-full border-2 border-black px-[2.5rem] py-[1rem] text-[1rem]"
        onClick={() => {
          setStartPage(false);
        }}
      >
